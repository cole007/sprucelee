...
class SpruceLeePlugin extends BasePlugin
{
    /**
    ...
    {
        // https://craftcms.stackexchange.com/questions/488/console-script-tags-garbling-up-non-html-output-e-g-json-when-in-devmode
    ...
    {
        return Craft::t('Clean up assets not in use');
    }
